...
user_choice_role = str(input("Which role should user be having?"))
...
driver.find_element(By.XPATH,"(//input[@class='oxd-input oxd-input--active'])[2]").send_keys('test1')
...
try:
    ...
    print(f"User creation failed due to error {e}")
else:
    print("User creation is successfully done")
